...
\begin{figure}[htbp]
 ...
 \subfigure[NumPy backend]{%
  \includegraphics[width=0.5\textwidth]{relative_times_numpy_log.eps}\label{fig:relrelative_time_numpy}%
 }
 \subfigure[TensorFlow backend]{%
  \includegraphics[width=0.5\textwidth]{relative_times_tensorflow_log.eps}\label{fig:relrelative_time_tensorflow}%
 }\hfil
