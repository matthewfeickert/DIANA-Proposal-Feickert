...
Partnering with Lukas Heinrich, who then further mentored and worked with Matthew, pyhf~\cite{lukas_heinrich_2018_1172961} --- a Python based implementation of the \code{HistFactory}~\cite{Cranmer:2012sba} spec in which different computational graph frameworks could be used as backends --- was developed.
